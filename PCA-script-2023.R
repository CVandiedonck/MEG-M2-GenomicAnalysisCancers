...
## To see packages imported into your worspace
search()
...
setwd("//Users/fabienfauchereau/Documents/ENSEIGNEMENT/2019-2020/UE-M2/Preparation_TP/")
...
summary(res, ncp=3, nbelements=Inf, file="pca-essai.txt" )
